        ...
        <div className="container mx-auto">
            <div className="flex justify-between gap-x-8">
                ...
                text-center xl:text-left">
                    ...
                    <h1 className="h1 mb-4">Hello, my name is Bandit Khawyen</h1>
                    <p className="subtitle max-w-[490px] mx-auto xl:mx-0">I graduated from the Faculty of Engineering, majoring in Computer Engineering. Currently, 
                        I work in the position of frontend programmer.
                    </p>
                    {/* {button} */}
